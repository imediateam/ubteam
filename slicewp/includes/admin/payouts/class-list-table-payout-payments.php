...
Class SliceWP_WP_List_Table_Payout_Payments extends SliceWP_WP_List_Table {
	...
	public function column_actions( $item ) {
		...
		$output  = '<div class="row-actions">';
			...
			$output .= '<span class="trash"><a onclick="return confirm( \'' . __( "Are you sure you want to delete this payment?", "slicewp" ) . ' \' )" href="' . wp_nonce_url( add_query_arg( array( 'page' => 'slicewp-payouts', 'subpage' => 'view-payout', 'slicewp_action' => 'delete_payment', 'payout_id' => $item['payout_id'], 'payment_id' => $item['id'] ) , admin_url( 'admin.php' ) ), 'slicewp_delete_payment', 'slicewp_token' ) . '" class="submitdelete">' . __( 'Delete', 'slicewp' ) . '</a></span>';
		$output .= '</div>';
